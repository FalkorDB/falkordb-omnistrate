...
if [[ ! -z $SINGLEZONESENTINELLBLB_SERVICE_HOST ]]; then
  SENTINEL_HOST=$SINGLEZONESENTINELLBLB_SERVICE_HOST
elif [[ ! -z $MULTIZONESENTINELLBLB_SERVICE_HOST ]]; then
  SENTINEL_HOST=$MULTIZONESENTINELLBLB_SERVICE_HOST
fi
