...
def test_update_memory():
    ...
    try:
        ...
        # Update memory
        logging.info("Updating network type to PRIVATE")
        instance.update_params(network_type="PRIVATE", wait_until_ready=True)

        query_data(instance)

        logging.info("Updating network type to PUBLIC")
        instance.update_params(network_type="PUBLIC", wait_until_ready=True)
